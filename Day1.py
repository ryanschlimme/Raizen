...
C.apply("bin_average", Npts = 100, inplace = True) # reduces data size by factor of 100 by 
	# averaging over Npts
C.average("PSD", taumax = 20e-3) #averages and sets equal to C.freq and C.psd and C.Navg_psd 					#(how many averages), taumax splits time domain to generate
					# more averages
